...
export const createAtletSchema = z.object({
  ...
  // Revisi 2026-07-18: cedera detail; null clears the value, and the routes
  // clear both whenever the (effective) status is anything other than INJURED.
  tanggalCedera: z.coerce.date().nullable().optional(),
  keteranganCedera: z.string().nullable().optional(),
